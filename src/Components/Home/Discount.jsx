...
const Discount = () => {
    return (
        <div className='max-w-screen-2xl mb-44 mx-auto gap-5 flex flex-col'>
            <div className='flex gap-5'>
                <div className='w-1/2 rounded-2xl h-80 p-16 flex justify-center flex-col space-y-5 bg-[#F3EBFF]'>
                ...
                <div className='w-1/2 rounded-2xl h-80 p-16 flex justify-center flex-col space-y-5 bg-[#FFCBE7]'>
            ...
            <div className=' rounded-2xl w-full p-5 flex justify-between  space-y-5 bg-[#FFEFF4]'>
                ...
                <div className='w-1/2 space-y-5 flex justify-center flex-col'>
