    ...
    return (
        <footer className="   text-gray-800">
            <div className="relative h-full w-full bg-slate-900  text-white ">
                ...
                <div className="relative  w-full z-10 max-w-screen-2xl mx-auto  p-8 bg-opacity-30 backdrop-blur-md rounded-lg">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a  className="flex justify-center space-x-3 lg:justify-start">
                        <img src={logo} className='w-14' alt="" />
                        <span className="self-center text-2xl font-semibold">loopmi</span>
                    </a>
